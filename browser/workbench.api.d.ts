...
declare class VSBuffer{
	...
	indexOf(subarray: VSBuffer | Uint8Array, offset: number): any;

	equals(other: VSBuffer): boolean;

}

declare function decodeBase64(encoded: string): any;

declare function encodeBase64(buffer: VSBuffer, padded: boolean, urlSafe: boolean): any ;
...
declare function ltrim(haystack: string, needle: string): string;
...
export {
	...
	// Welcome dialog
	IWelcomeDialog, parse, decodeBase64, encodeBase64, VSBuffer, posix, ltrim, isFolderToOpen, isWorkspaceToOpen
};
